namespace Eisdealer {
 ...
 let becher: HTMLElement;
    ...
    let flavors: string[] = ["vanilla", "chocolate", "strawberry", "yoghurt",
        "peppermint", "citrus", "pomegranate", "berries",
        "hazelnut", "walnut", "cherry", "coconut"];

    let sauces: string[] = ["vanilla", "chocolate", "strawberry", "caramel", "whipped cream"];

    let toppings: string[] = ["sprinkles", "fruit", "coconut flakes", "oreo", "chocolate chips"];

    let cone: string[] = ["Wafflecone", "Cone"];
