namespace L5_Canvas {
   ...
   function drawKorb(_x: number, _y: number, _strokeColor: string, _fillColor: string, _strokeColor1: string, _fillColor1: string): void {
       ...
       function drawBiene(_x: number, _y: number ): void {
        ...
        crc2.arc(_x + 2 , _y - 12 , 5, 180, 270); 
        crc2.moveTo(_x + 9 , _y - 12);
        crc2.arc(_x + 9 , _y - 12 , 5, 180, 270);    
        crc2.closePath();
        crc2.fill();
        crc2.stroke();
